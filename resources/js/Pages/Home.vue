...
const fetchReceivingStatuses = () => {
  return receivingService
    .status()
    .then((response) => {
      receivingStatuses.value = response;
    })
    .catch((error) => {
      errors.value = error;
    });
          ...
          <div class="row">
            <div class="col-xl-4">
              ...
              <div class="card card-custom card-stretch gutter-b">
                ...
                <div class="card-body pt-0">
                  <!--begin::Item-->
                  <template v-if="orderStatuses.length > 0">
                    <div
                      v-for="(status, s) in orderStatuses"
                      :key="s"
            ...
            <div class="col-xl-4">
              ...
              <div class="card card-custom card-stretch gutter-b">
                ...
                <div class="card-body pt-0">
                  <!--begin::Item-->
                  <template v-if="receivingStatuses.length > 0">
                    <div
                      v-for="(receiving, r) in receivingStatuses"
                      :key="r"
                      class="d-flex align-items-center flex-wrap mb-8"
                    >
                      <!--begin::Text-->
                      ...
                      <span
                        class="label label-xl label-light label-inline my-lg-0 my-2 text-dark-50 font-weight-bolder"
                        >{{ receiving.receivings_count }}</span
                      >
                    </div>
                  </template>
                  <!--end::Item-->
