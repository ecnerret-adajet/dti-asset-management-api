      ...
      <div class="container">
              ...
              <div class="col-xl-6">
                ...
                >
                  ...
                  <div class="card-body d-flex align-items-center">
                    <div>
                      <h3
                        class="text-white font-weight-bolder line-height-lg mb-5"
                      >
                        Create SaaS <br />Based Reports
                      </h3>
                      <a
                        href="#"
                        class="btn btn-success font-weight-bold px-6 py-3"
                        >Create Report</a
                      >
                    </div>
                  </div>
        ...
        <div class="row">
          <div class="col-lg-6 col-xxl-4">
            ...
            <div
              class="card card-custom bg-radial-gradient-danger gutter-b card-stretch"
            >
              <!--begin::Header-->
            ...
            <div class="card card-custom card-stretch gutter-b">
              ...
              <div class="card-body d-flex flex-column">
                <div class="flex-grow-1 pb-5">
                  ...
                  <!--begin::Desc-->
                  <p class="text-dark-50 font-weight-normal font-size-lg mt-6">
                    Easy to use, incredibly flexible and secure <br />with
                    in-depth documentation that outlines <br />everything for
                    you
                  </p>
                  <!--end::Desc-->
                </div>
          ...
          <div class="col-lg-6">
            ...
            <div class="card card-custom card-stretch gutter-b">
              ...
              <div class="card-body pt-0">
                ...
                <!--begin::Item-->
                <div
                  class="d-flex align-items-center bg-light-success rounded p-5 mb-9"
                >
                  <!--begin::Icon-->
                  ...
                  <!--begin::Lable-->
                  <span
                    class="font-weight-bolder text-success py-1 font-size-lg"
                    >+50%</span
                  >
                  <!--end::Lable-->
                </div>
                ...
                <!--begin::Item-->
                <div
                  class="d-flex align-items-center bg-light-danger rounded p-5 mb-9"
                >
                  <!--begin::Icon-->
