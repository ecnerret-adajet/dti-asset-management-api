...
const storeUser = () => {
  form.post("/users", {
    onSuccess: () => {
      sweetAlert.basicAlert("Created succesfully!", "New User", "success");
    },
  });
};
    ...
    <div class="card card-custom card-stretch">
      ...
      <div class="card-header py-3">
        <div class="card-title align-items-start flex-column">
          <h3 class="card-label font-weight-bolder text-dark">New User</h3>
      ...
      <form class="form" @submit.prevent="storeAsset">
        ...
        <div class="card-body">
          ...
          <div class="form-group row">
            <label class="col-xl-3 col-lg-3 col-form-label">Confirm Passowrd</label>
            <div class="col-lg-9 col-xl-6">
              <input
