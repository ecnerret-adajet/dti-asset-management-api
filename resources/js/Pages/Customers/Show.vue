                ...
                <div class="card-body">
                    ...
                    <div class="flex-grow-1">
                      ...
                      >
                        ...
                        >
                          ...
                          merely to inform people. <br />A second could be
                          persuade people. You want people to bay objective.
                        </div>
                  ...
                  <div class="d-flex align-items-center flex-wrap">
                    ...
                    >
                      <span class="mr-4">
                        <i
                          class="flaticon-chat-1 icon-2x text-muted font-weight-bold"
                        ></i>
                      </span>
                    ...
                    <div class="d-flex align-items-center flex-lg-fill my-1">
                      <span class="mr-4">
                        <i
                          class="flaticon-network icon-2x text-muted font-weight-bold"
                        ></i>
                      </span>
                            ...
                            <tr>
                              <td class="pl-0 py-8">
                                <div class="d-flex align-items-center">
                                  <div
                                    class="symbol symbol-50 flex-shrink-0 mr-4"
                                  >
                                    <div
                                      class="symbol-label"
                                      style="
                                        background-image: url('assets/media/stock-600x400/img-26.jpg');
                                      "
                                    ></div>
                                  </div>
                                  <div>
                                ...
                                <div class="d-flex align-items-center">
                                  ...
                                  >
                                    <div
                                      class="symbol-label"
                                      style="
                                        background-image: url('assets/media/stock-600x400/img-3.jpg');
                                      "
                                    ></div>
                                  </div>
                                  <div>
                                ...
                                <div class="d-flex align-items-center">
                                  ...
                                  >
                                    <div
                                      class="symbol-label"
                                      style="
                                        background-image: url('assets/media/stock-600x400/img-5.jpg');
                                      "
                                    ></div>
                                  </div>
                                  <div>
                                ...
                                <div class="d-flex align-items-center">
                                  ...
                                  >
                                    <div
                                      class="symbol-label"
                                      style="
                                        background-image: url('assets/media/stock-600x400/img-18.jpg');
                                      "
                                    ></div>
                                  </div>
                                  <div>
                      ...
                      <div class="d-flex flex-wrap align-items-center mb-10">
                        ...
                        >
                          <div
                            class="symbol-label"
                            style="
                              background-image: url('assets/media/stock-600x400/img-17.jpg');
                            "
                          ></div>
                        </div>
                        <!--end::Symbol-->
                      ...
                      <div class="d-flex flex-wrap align-items-center mb-10">
                        ...
                        <div class="d-flex align-items-center py-lg-0 py-2">
                          <div class="d-flex flex-column text-right">
                            ...
                            >
                            <span
                              class="text-muted font-weight-bolder font-size-sm"
                              >votes</span
                            >
                          </div>
                        </div>
                      ...
                      <div class="d-flex flex-wrap align-items-center mb-10">
                        ...
                        >
                          <div
                            class="symbol-label"
                            style="
                              background-image: url('assets/media/stock-600x400/img-1.jpg');
                            "
                          ></div>
                        </div>
                        <!--end::Symbol-->
                        ...
                        <div class="d-flex align-items-center py-lg-0 py-2">
                          <div class="d-flex flex-column text-right">
                            <span
                              class="text-dark-75 font-size-h4 font-weight-bolder"
                              >7,200</span
                            >
                            <span
                              class="text-muted font-size-sm font-weight-bolder"
                      ...
                      <div class="d-flex flex-wrap align-items-center mb-10">
                        ...
                        >
                          <div
                            class="symbol-label"
                            style="
                              background-image: url('assets/media/stock-600x400/img-9.jpg');
                            "
                          ></div>
                        </div>
                        <!--end::Symbol-->
                        ...
                        >
                          ...
                          >
                          <span
                            class="text-muted font-size-sm font-weight-bold my-1"
                      ...
                      <div class="d-flex flex-wrap align-items-center">
                        ...
                        >
                          <div
                            class="symbol-label"
                            style="
                              background-image: url('assets/media/stock-600x400/img-12.jpg');
                            "
                          ></div>
                        </div>
                        <!--end::Symbol-->
                            ...
                            <ul class="navi">
                              ...
                              <li class="navi-item">
                                <a href="#" class="navi-link">
                                  <span class="navi-icon">
                                    <i
                                      class="navi-icon flaticon2-calendar-8"
                                    ></i>
                                  </span>
                              ...
                              <li class="navi-item">
                                <a href="#" class="navi-link">
                                  <span class="navi-icon">
                                    <i
                                      class="navi-icon flaticon2-new-email"
                                    ></i>
                                  </span>
                  ...
                  <div class="card card-custom card-stretch gutter-b">
                    ...
                    <div class="card-body pt-0">
                      ...
                      <div class="">
                        ...
                        <!--begin::Desc-->
                        <p class="text-dark-50 m-0 pt-5 font-weight-normal">
                          A brief write up about the New Users that fits within
                          this section
                        </p>
                        <!--end::Desc-->
                      </div>
